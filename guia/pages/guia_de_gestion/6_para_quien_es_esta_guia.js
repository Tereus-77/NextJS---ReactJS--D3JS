...
class Metodologia extends Component {
  ...
  main = (element) => {
    ...
    *******************************/
    ...
    const x_triangle = rp(804.5, 'x', width, height);
    ...
    *******************************/
    ...
    //text answer
    const textAnswer = 'Para personas involucradas de manera directa o indirecta en la gestión de la cadena de suministro, ya sea como mandantes y/o proveedores.<br/><br/>Para quienes toman decisiones a nivel gerencial.<br/><br/>Para todas las áreas involucradas en la cadena de suministro: Compras, Administración, Finanzas, Soporte, Tecnología, Cumplimiento, Riesgo y Control Interno.'
    setHtmlText(svg, 1, 'textQuestion'+i, 
                (rp(795.04, 'x', width, height)),
                (width/4.22 + i * width/41), 
                (rp(874.32, 'x', width, height)),
                (rp(480, 'x', width, height)),
                textAnswer, 
                (rp(21.34, 'x', width, height)), 'Roboto', 'justify', 0, 'black', '',)
    ...
    *******************************/
    breadcrumb(svg, width, height, 'Inicio', 'Guía de Gestión', 'guia_de_gestion', '¿Para quién es esta guía?');
    /******************************
