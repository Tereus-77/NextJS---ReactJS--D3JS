...
class Metodologia extends Component {
  ...
  main = (element) => {
    ...
    *******************************/
    //punta
    //triangle
    const x_triangle = rp(1525, 'x', width, height);
...
/*svg.append('rect')
  ...
  svg.append('rect')
    ...
    *******************************/
    breadcrumb(svg, width, height, 'Inicio', 'Guía de Gestión', 'guia_de_gestion', 'Beneficios');
    /******************************
