...
class Etapas extends Component {
  ...
  main = (element) => {
    ...
    ****************************************/
    ...
    posicionEnElArco[4] = 10;
    posicionEnElArco[5] = 10;
    posicionEnElArco[6] = 10;
    posicionEnElArco[7] = 10;
    ...
    ****************************************/
    ...
    // Etapa Necesidad 0
    const arrayPactoGlobal_0_0 = ['3-c', '4-c', '5-c', '6-c', '6-c', '6-c'];  // Leyes sociales // E7
    const arrayPactoGlobal_0_1 = ['3-c', '4-c', '5-c', '7-c'];  // Salud y seguridad ocupacional
    const arrayPactoGlobal_0_2 = ['3-c', '4-c', '5-c', '8-c'];  // Trabajo infantil
    const arrayPactoGlobal_0_3 = ['3-c', '4-c', '5-c', '6-c'];  // Trabajo esclavo
    const arrayPactoGlobal_0_4 = ['7-c', '8-c', '9-c'];         // Normativa ambiental
    const arrayPactoGlobal_0_5 = ['10-c'];                      // Normativas de transparencia e integridad
    const arrayPactoGlobal_0_6 = ['10-c'];                      // Viabilidad y transparencia financiera
    const arrayPactoGlobal_0_7 = ['3-c', '4-c', '5-c', '6-c'];  // Normativa libertad de asociación

    const arrayODS_0_0 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Leyes sociales // F7
    const arrayODS_0_1 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Salud y seguridad ocupacional
    const arrayODS_0_2 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Trabajo infantil
    const arrayODS_0_3 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Trabajo esclavo
    const arrayODS_0_4 = ['2-c', '6-c', '7-c', '9-c', '11-c', '12-c', '13-c', '14-c', '15-c', '17-c'];// Normativa ambiental
    const arrayODS_0_5 = ['3-c', '10-c', '16-c', '17-c'];// Normativas de transparencia e integridad
    const arrayODS_0_6 = ['3-c', '10-c', '16-c', '17-c'];// Viabilidad y transparencia financiera
    const arrayODS_0_7 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Normativa libertad de asociación

    // Etapa Solicitud pedido (riesgo propio) 1
    const arrayPactoGlobal_1_0 = ['3-m', '4-m', '5-m', '6-m'];// Leyes sociales
    const arrayPactoGlobal_1_1 = ['3-m', '4-m', '5-m', '7-m'];// Salud y seguridad ocupacional
    const arrayPactoGlobal_1_2 = ['3-m', '4-m', '5-m', '8-m'];// Trabajo infantil
    const arrayPactoGlobal_1_3 = ['3-m', '4-m', '5-m', '6-m'];// Trabajo esclavo
    const arrayPactoGlobal_1_4 = ['7-m', '8-m', '9-m'];// Normativa ambiental
    const arrayPactoGlobal_1_5 = ['10-m'];// Normativas de transparencia e integridad
    const arrayPactoGlobal_1_6 = ['10-m'];// Viabilidad y transparencia financiera
    const arrayPactoGlobal_1_7 = ['3-m', '4-m', '5-m', '6-m'];// Normativa libertad de asociación

    const arrayODS_1_0 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Leyes sociales
    const arrayODS_1_2 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Salud y seguridad ocupacional
    const arrayODS_1_1 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Trabajo infantil
    const arrayODS_1_3 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Trabajo esclavo
    const arrayODS_1_7 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Normativa ambiental
    const arrayODS_1_4 = ['2-m', '6-m', '7-m', '9-m', '11-m', '12-m', '13-m', '14-m', '15-m', '17-m'];// Normativas de transparencia e integridad
    const arrayODS_1_5 = ['3-m', '10-m', '16-m', '17-m'];// Viabilidad y transparencia financiera
    const arrayODS_1_6 = ['3-m', '10-m', '16-m', '17-m'];// Normativa libertad de asociación



    // Etapa Fuentes de aprovisionamiento 2
    const arrayPactoGlobal_2_0 = ['3-c', '4-c', '5-c', '6-c'];// Leyes sociales
    const arrayPactoGlobal_2_1 = ['3-c', '4-c', '5-c', '7-c'];// Salud y seguridad ocupacional
    const arrayPactoGlobal_2_2 = ['3-c', '4-c', '5-c', '8-c'];// Trabajo infantil
    const arrayPactoGlobal_2_3 = ['3-c', '4-c', '5-c', '6-c'];// Trabajo esclavo
    const arrayPactoGlobal_2_4 = ['7-c', '8-c', '9-c'];// Normativa ambiental
    const arrayPactoGlobal_2_5 = ['10-c'];// Normativas de transparencia e integridad
    const arrayPactoGlobal_2_6 = ['10-c'];// Viabilidad y transparencia financiera
    const arrayPactoGlobal_2_7 = ['3-c', '4-c', '5-c', '6-c'];// Normativa libertad de asociación

    const arrayODS_2_0 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Leyes sociales
    const arrayODS_2_2 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Salud y seguridad ocupacional
    const arrayODS_2_1 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Trabajo infantil
    const arrayODS_2_3 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Trabajo esclavo
    const arrayODS_2_4 = ['2-c', '6-c', '7-c', '9-c', '11-c', '12-c', '13-c', '14-c', '15-c', '17-c'];// Normativa ambiental
    const arrayODS_2_5 = ['3-c', '10-c', '16-c', '17-c'];// Normativas de transparencia e integridad
    const arrayODS_2_6 = ['3-c', '10-c', '16-c', '17-c'];// Viabilidad y transparencia financiera
    const arrayODS_2_7 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Normativa libertad de asociación

    // Etapa Creación y seguimiento orden de compra/contrato 3
    const arrayPactoGlobal_3_0 = ['3-c', '4-c', '5-c', '6-c'];// Leyes sociales
    const arrayPactoGlobal_3_1 = ['3-c', '4-c', '5-c', '7-c'];// Salud y seguridad ocupacional
    const arrayPactoGlobal_3_2 = ['3-c', '4-c', '5-c', '8-c'];// Trabajo infantil
    const arrayPactoGlobal_3_3 = ['3-c', '4-c', '5-c', '6-c'];// Trabajo esclavo
    const arrayPactoGlobal_3_4 = ['7-c', '8-c', '9-c'];// Normativa ambiental
    const arrayPactoGlobal_3_5 = ['10-c'];// Normativas de transparencia e integridad
    const arrayPactoGlobal_3_6 = ['10-c'];// Viabilidad y transparencia financiera
    const arrayPactoGlobal_3_7 = ['3-c', '4-c', '5-c', '6-c'];// Normativa libertad de asociación

    const arrayODS_3_0 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Leyes sociales
    const arrayODS_3_2 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Salud y seguridad ocupacional
    const arrayODS_3_1 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Trabajo infantil
    const arrayODS_3_3 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Trabajo esclavo
    const arrayODS_3_4 = ['2-c', '6-c', '7-c', '9-c', '11-c', '12-c', '13-c', '14-c', '15-c', '17-c'];// Normativa ambiental
    const arrayODS_3_5 = ['3-c', '10-c', '16-c', '17-c'];// Normativas de transparencia e integridad
    const arrayODS_3_6 = ['3-c', '10-c', '16-c', '17-c'];// Viabilidad y transparencia financiera
    const arrayODS_3_7 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Normativa libertad de asociación

    // Etapa Ejecución del servicio y administración del contrato 4
    const arrayPactoGlobal_4_0 = ['3-c', '4-c', '5-c', '6-c'];// Leyes sociales
    const arrayPactoGlobal_4_1 = ['3-c', '4-c', '5-c', '7-c'];// Salud y seguridad ocupacional
    const arrayPactoGlobal_4_2 = ['3-c', '4-c', '5-c', '8-c'];// Trabajo infantil
    const arrayPactoGlobal_4_3 = ['3-c', '4-c', '5-c', '6-c'];// Trabajo esclavo
    const arrayPactoGlobal_4_4 = ['7-c', '8-c', '9-c'];// Normativa ambiental
    const arrayPactoGlobal_4_5 = ['10-c'];// Normativas de transparencia e integridad
    const arrayPactoGlobal_4_6 = ['10-c'];// Viabilidad y transparencia financiera
    const arrayPactoGlobal_4_7 = ['3-c', '4-c', '5-c', '6-c'];// Normativa libertad de asociación

    const arrayODS_4_0 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Leyes sociales
    const arrayODS_4_2 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Salud y seguridad ocupacional
    const arrayODS_4_1 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Trabajo infantil
    const arrayODS_4_3 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Trabajo esclavo
    const arrayODS_4_4 = ['2-c', '6-c', '7-c', '9-c', '11-c', '12-c', '13-c', '14-c', '15-c', '17-c'];// Normativa ambiental
    const arrayODS_4_5 = ['3-c', '10-c', '16-c', '17-c'];// Normativas de transparencia e integridad
    const arrayODS_4_6 = ['3-c', '10-c', '16-c', '17-c'];// Viabilidad y transparencia financiera
    const arrayODS_4_7 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Normativa libertad de asociación

    // Etapa Recepción de mercancias – Recepción del servicio 5
    const arrayPactoGlobal_5_0 = ['3-m', '4-m', '5-m', '6-m'];// Leyes sociales
    const arrayPactoGlobal_5_1 = ['3-m', '4-m', '5-m', '7-m'];// Salud y seguridad ocupacional
    const arrayPactoGlobal_5_2 = ['3-m', '4-m', '5-m', '8-m'];// Trabajo infantil
    const arrayPactoGlobal_5_3 = ['3-m', '4-m', '5-m', '6-m'];// Trabajo esclavo
    const arrayPactoGlobal_5_4 = ['7-m', '8-m', '9-m'];// Normativa ambiental
    const arrayPactoGlobal_5_5 = ['10-m'];// Normativas de transparencia e integridad
    const arrayPactoGlobal_5_6 = ['10-m'];// Viabilidad y transparencia financiera
    const arrayPactoGlobal_5_7 = ['3-m', '4-m', '5-m', '6-m'];// Normativa libertad de asociación

    const arrayODS_5_0 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Leyes sociales
    const arrayODS_5_2 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Salud y seguridad ocupacional
    const arrayODS_5_1 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Trabajo infantil
    const arrayODS_5_3 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Trabajo esclavo
    const arrayODS_5_4 = ['2-m', '6-m', '7-m', '9-m', '11-m', '12-m', '13-m', '14-m', '15-m', '17-m'];// Normativa ambiental
    const arrayODS_5_5 = ['3-m', '10-m', '16-m', '17-m'];// Normativas de transparencia e integridad
    const arrayODS_5_6 = ['3-m', '10-m', '16-m', '17-m'];// Viabilidad y transparencia financiera
    const arrayODS_5_7 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Normativa libertad de asociación

    // Etapa Recepción de facturas 6
    const arrayPactoGlobal_6_0 = ['3-m', '4-m', '5-m', '6-m'];// Leyes sociales
    const arrayPactoGlobal_6_1 = ['3-m', '4-m', '5-m', '7-m'];// Salud y seguridad ocupacional
    const arrayPactoGlobal_6_2 = ['3-m', '4-m', '5-m', '8-m'];// Trabajo infantil
    const arrayPactoGlobal_6_3 = ['3-m', '4-m', '5-m', '6-m'];// Trabajo esclavo
    const arrayPactoGlobal_6_4 = ['7-m', '8-m', '9-m'];// Normativa ambiental
    const arrayPactoGlobal_6_5 = ['10-m'];// Normativas de transparencia e integridad
    const arrayPactoGlobal_6_6 = ['10-m'];// Viabilidad y transparencia financiera
    const arrayPactoGlobal_6_7 = ['3-m', '4-m', '5-m', '6-m'];// Normativa libertad de asociación

    const arrayODS_6_0 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Leyes sociales
    const arrayODS_6_2 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Salud y seguridad ocupacional
    const arrayODS_6_1 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Trabajo infantil
    const arrayODS_6_3 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Trabajo esclavo
    const arrayODS_6_4 = ['2-m', '6-m', '7-m', '9-m', '11-m', '12-m', '13-m', '14-m', '15-m', '17-m'];// Normativa ambiental
    const arrayODS_6_5 = ['3-m', '10-m', '16-m', '17-m'];// Normativas de transparencia e integridad
    const arrayODS_6_6 = ['3-m', '10-m', '16-m', '17-m'];// Viabilidad y transparencia financiera
    const arrayODS_6_7 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Normativa libertad de asociación

    // Etapa Verificación de facturas 7
    const arrayPactoGlobal_7_0 = ['3-m', '4-m', '5-m', '6-m'];// Leyes sociales
    const arrayPactoGlobal_7_1 = ['3-m', '4-m', '5-m', '7-m'];// Salud y seguridad ocupacional
    const arrayPactoGlobal_7_2 = ['3-m', '4-m', '5-m', '8-m'];// Trabajo infantil
    const arrayPactoGlobal_7_3 = ['3-m', '4-m', '5-m', '6-m'];// Trabajo esclavo
    const arrayPactoGlobal_7_4 = ['7-m', '8-m', '9v'];// Normativa ambiental
    const arrayPactoGlobal_7_5 = ['10-m'];// Normativas de transparencia e integridad
    const arrayPactoGlobal_7_6 = ['10v'];// Viabilidad y transparencia financiera
    const arrayPactoGlobal_7_7 = ['3-m', '4-m', '5-m', '6-m'];// Normativa libertad de asociación

    const arrayODS_7_0 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Leyes sociales
    const arrayODS_7_2 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Salud y seguridad ocupacional
    const arrayODS_7_1 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Trabajo infantil
    const arrayODS_7_3 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Trabajo esclavo
    const arrayODS_7_4 = ['2-m', '6-m', '7-m', '9-m', '11-m', '12-m', '13-m', '14-m', '15-m', '17-m'];// Normativa ambiental
    const arrayODS_7_5 = ['3-m', '10-m', '16-m', '17-m'];// Normativas de transparencia e integridad
    const arrayODS_7_6 = ['3-m', '10-m', '16-m', '17-m'];// Viabilidad y transparencia financiera
    const arrayODS_7_7 = ['1-m', '3-m', '5-m', '8-m', '9-m', '10-m', '16-m', '17-m'];// Normativa libertad de asociación

    // Etapa Proceso de pago 8
    const arrayPactoGlobal_8_0 = ['3-c', '4-c', '5-c', '6-c'];// Leyes sociales
    const arrayPactoGlobal_8_1 = ['3-c', '4-c', '5-c', '7-c'];// Salud y seguridad ocupacional
    const arrayPactoGlobal_8_2 = ['3-c', '4-c', '5-c', '8-c'];// Trabajo infantil
    const arrayPactoGlobal_8_3 = ['3-c', '4-c', '5-c', '6-c'];// Trabajo esclavo
    const arrayPactoGlobal_8_4 = ['7-c', '8-c', '9-c'];// Normativa ambiental
    const arrayPactoGlobal_8_5 = ['10-c'];// Normativas de transparencia e integridad
    const arrayPactoGlobal_8_6 = ['10-c'];// Viabilidad y transparencia financiera
    const arrayPactoGlobal_8_7 = ['3-c', '4-c', '5-c', '6-c'];// Normativa libertad de asociación

    const arrayODS_8_0 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Leyes sociales
    const arrayODS_8_2 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Salud y seguridad ocupacional
    const arrayODS_8_1 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Trabajo infantil
    const arrayODS_8_3 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Trabajo esclavo
    const arrayODS_8_4 = ['2-c', '6-c', '7-c', '9-c', '11-c', '12-c', '13-c', '14-c', '15-c', '17-c'];// Normativa ambiental
    const arrayODS_8_5 = ['3-c', '10-c', '16-c', '17-c'];// Normativas de transparencia e integridad
    const arrayODS_8_6 = ['3-c', '10-c', '16-c', '17-c'];// Viabilidad y transparencia financiera
    const arrayODS_8_7 = ['1-c', '3-c', '5-c', '8-c', '9-c', '10-c', '16-c', '17-c'];// Normativa libertad de asociación

    // Etapa Evaluación y cierre 9
    const arrayPactoGlobal_9_0 = [];// Leyes sociales
    const arrayPactoGlobal_9_1 = [];// Salud y seguridad ocupacional
    const arrayPactoGlobal_9_2 = [];// Trabajo infantil
    const arrayPactoGlobal_9_3 = [];// Trabajo esclavo
    const arrayPactoGlobal_9_4 = [];// Normativa ambiental
    const arrayPactoGlobal_9_5 = [];// Normativas de transparencia e integridad
    const arrayPactoGlobal_9_6 = [];// Viabilidad y transparencia financiera
    const arrayPactoGlobal_9_7 = [];// Normativa libertad de asociación

    const arrayODS_9_0 = [];// Leyes sociales
    const arrayODS_9_2 = [];// Salud y seguridad ocupacional
    const arrayODS_9_1 = [];// Trabajo infantil
    const arrayODS_9_3 = [];// Trabajo esclavo
    const arrayODS_9_4 = [];// Normativa ambiental
    const arrayODS_9_5 = [];// Normativas de transparencia e integridad
    const arrayODS_9_6 = [];// Viabilidad y transparencia financiera
    const arrayODS_9_7 = [];// Normativa libertad de asociación
    ...
    const arrayEtapasPactoGlobal_0 = [
      ...
      arrayPactoGlobal_0_4,
      arrayPactoGlobal_0_5,
      arrayPactoGlobal_0_6,
      arrayPactoGlobal_0_7
    ];
    // Solicitud pedido (riesgo propio)
    const arrayEtapasPactoGlobal_1 = [
      arrayPactoGlobal_1_0, // Leyes sociales
      arrayPactoGlobal_1_1,
      arrayPactoGlobal_1_2,
      arrayPactoGlobal_1_3,
      arrayPactoGlobal_1_4,
      arrayPactoGlobal_1_5,
      arrayPactoGlobal_1_6,
      arrayPactoGlobal_1_7 // Normativa libertad de asociación
    ];
    const arrayEtapasPactoGlobal_2 = [
      ...
      arrayPactoGlobal_2_4,
      arrayPactoGlobal_2_5,
      arrayPactoGlobal_2_6,
      arrayPactoGlobal_2_7
    ];
    const arrayEtapasPactoGlobal_3 = [
      ...
      arrayPactoGlobal_3_4,
      arrayPactoGlobal_3_5,
      arrayPactoGlobal_3_6,
      arrayPactoGlobal_3_7
    ];
    const arrayEtapasPactoGlobal_4 = [
      ...
      arrayPactoGlobal_4_4,
      arrayPactoGlobal_4_5,
      arrayPactoGlobal_4_6,
      arrayPactoGlobal_4_7
    ];
    const arrayEtapasPactoGlobal_5 = [
      ...
      arrayPactoGlobal_5_4,
      arrayPactoGlobal_5_5,
      arrayPactoGlobal_5_6,
      arrayPactoGlobal_5_7
    ];
    const arrayEtapasPactoGlobal_6 = [
      ...
      arrayPactoGlobal_6_4,
      arrayPactoGlobal_6_5,
      arrayPactoGlobal_6_6,
      arrayPactoGlobal_6_7
    ];
    const arrayEtapasPactoGlobal_7 = [
      ...
      arrayPactoGlobal_7_4,
      arrayPactoGlobal_7_5,
      arrayPactoGlobal_7_6,
      arrayPactoGlobal_7_7
    ];
    const arrayEtapasPactoGlobal_8 = [
      ...
      arrayPactoGlobal_8_4,
      arrayPactoGlobal_8_5,
      arrayPactoGlobal_8_6,
      arrayPactoGlobal_8_7
    ];
    const arrayEtapasPactoGlobal_9 = [
      ...
      arrayPactoGlobal_9_4,
      arrayPactoGlobal_9_5,
      arrayPactoGlobal_9_6,
      arrayPactoGlobal_9_7
    ];
    ...
    const arrayEtapaODS_0 = [
      arrayODS_0_0, // Leyes sociales
      arrayODS_0_1, //Salud y seguridad ocupacional
      arrayODS_0_2, // Trabajo infantil
      arrayODS_0_3, // Trabajo esclavo
      arrayODS_0_4, // Normativa ambiental
      arrayODS_0_5, // Normativas de transparencia e integridad
      arrayODS_0_6, // Viabilidad y transparencia financiera
      arrayODS_0_7 // Normativa libertad de asociación
    ];
    // Solicitud pedido (riesgo propio)
    ...
    *****************************************/
    ...
    const y_practicasContentBG = rp(770, 'x', width, height);
    ...
    const x_pageTitleBg = rp(1450, 'x', width, height);
    ...
    const y_contentDetalle = rp(830, 'x', width, height);
    ...
    *********************************************/
    ...
    practica.showClickDatellaPractica(0, svgCirculosPactoGlobal, svgCirculosOds, arrayPracticaDetalle, arrayEtapas, arrayPactoGlobal, arrayODS, width, height, colorRol, x_clickAreaArcoiris, y_clickAreaArcoiris, svgClicklAreaEtapas);


    // Área clickeable detalle práctica
    var arcLenA = 3.14 / arrayPracticaDetalle.length;
    var startAngle = -(4 * arcLenA);
    ...
    for (let i = 0; i < arrayPracticaDetalle.length; i++) {
      ...
      svgClicklAreaArcoiris.append('foreignObject')
        ...
        .html(function (d) {
          if(i == 0){
            return '<div style="-webkit-transform: rotate(10deg);font-family:Roboto;font-weight:normal;color:black;font-size:' + fonSize_detalle + 'px;' + divHeight_detalle + '"><p align="left" style="">' + arrayPracticaDetalle[i] + '</p></div>'
          }
          else{
      ...
      svgClicklAreaArcoiris.append("path")
        ...
        .on('click', function () {
          for (let i = 0; i < arrayPracticaDetalle.length; i++) {
            d3.select('#segmentTexetDetalleId' + i).remove()
            d3.select('#segment_' + i)
              .attr('opacity', 1)              
            svgClicklAreaArcoiris.append('foreignObject')
              .attr("id", 'segmentTexetDetalleId' + i)
              .attr('x', x_segmentText)
              .attr('y', y_segmentText)
              .attr("width", rp(200, 'x', width, height))
              .attr("height", rp(60, 'x', width, height))
